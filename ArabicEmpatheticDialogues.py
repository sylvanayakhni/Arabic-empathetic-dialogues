...
_URL = "https://raw.githubusercontent.com/sylvanayakhni/Arabic-empathetic-dialogues/main/arabic_empathetic_dialogues_above_2turns.csv"
...
class ArabicEmpConv(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            homepage="https://github.com/sylvanayakhni/Arabic-empathetic-dialogues",
        )
    ...
    def _generate_examples(self, filepath):
        with open("arabic_empathetic_dialogues_above_2turns.csv",'r',encoding='utf-8') as f:
            ...
            for i , row in enumerate(csv_reader):
                ...
                yield i-1, {
                    ...
                    "dialogue": arabert_prep.preprocess(row[2])
                }